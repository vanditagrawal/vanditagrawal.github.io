          ...
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div
                ...
                <div className="flex-col hidden gap-2 text-xl font-bold md:flex
                md:pl-20 md:text-4xl text-neutral-300">
                    <h3>{item.date}</h3>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
                <div className="block md-4 text-2xl font-bold text-left
